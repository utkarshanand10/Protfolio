...
function App() {
    ...
    const handleSubmitProject = async (e) => {
        ...
        try {
            ...
            if (isEditing && projectForm.existingImages) {
                                            ...
                                            {(project.images?.length > 0 ||
                                                ...
                                                <div className="flex -space-x-4 overflow-hidden">
                                                    ...
                                                    {project.images?.length >
                                                        3 && (
                                                        <div className="w-12 h-12 rounded-lg bg-slate-100 dark:bg-slate-800 border-2 border-white dark:border-slate-800 flex items-center justify-center text-xs font-bold text-slate-500">
                                                            +
                                                            {project.images
                                                                .length - 3}
                                                        </div>
